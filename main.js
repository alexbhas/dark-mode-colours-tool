let getChannel = (channel) => {
  ...
  let calcUpper = (lum) => {
    return 0.222222 * lum - 0.038889;
  }

  let calcLower = (lum) => {
    return 4.5 * lum + 0.175;
  }
  ...
  function generate(){
    ...
    if(invalidF == true && invalidS == true){
      ...
      let UPPER = calcUpper(firstLum);
      let LOWER = calcLower(secondLum);
      console.log("FLUM: " + firstLum);
      console.log("SLUM: " + secondLum);
